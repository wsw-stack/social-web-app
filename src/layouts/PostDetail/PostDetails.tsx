...
export const PostDetails: React.FC<{ postDetails: IPost, toggleLikePost: any, curUser: string | null }> = ({postDetails, toggleLikePost, curUser}) => {
    return (
        <div className="card">
